...
**Archived 2026-09-08. Non-authoritative discussion history.** The undated register and reverse-chronological discussion below are preserved as received, including obsolete questions and shorthand filenames. They do not describe current approvals. Use [current design status](../_status.md) and [element 20](../elements/20_tenant_interiors_visitor_interactions.md).
