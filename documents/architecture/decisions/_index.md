...
**Production integration decision, 2026-09-11:** [ADR 38](38_construction_tool_and_affected_scope_invalidation.md) accepts the scene-owned one-cell ground acquisition/corridor tool and operation-scoped synchronous District invalidation. It adds no authority or save state and forbids global rebuild amplification for `ACQUIRE_SPACE`.
