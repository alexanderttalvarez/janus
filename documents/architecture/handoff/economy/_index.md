...
| 02 | [Expansion Pricing and Refund Policy](02_expansion_pricing_and_refund_policy.md) | Draft — ready for architecture approval | Centralizes tunable approved prices for Plot Sections, vertical floor tiles, Street Segment conversion, and eligible demolition; defines no-refund/no-reversal MVP policy. Consumes but does not define progression gates. |
