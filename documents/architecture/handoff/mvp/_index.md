...
| 02 | [Product MVP Tenant Interiors Scope](02_product_mvp_tenant_interiors_scope.md) | Draft — awaiting architecture approval | Renames proxy-only behavior as the Corridor Service Integration Gate and requires Tenant Interiors H1–H5 for Product MVP completion. |
